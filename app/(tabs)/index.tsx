...
export default function HomeScreen() {
    ...
    const saveNewFriend = async () => {
        console.debug('saving new friend : ' + newContact + ' with frequency ' + selectedFrequency);
        await addNewFriend(createNewContactEntity(newContact, selectedFrequency));
        alert('New catch up registered ! 🚀');
        bottomSheetRef.current?.close();
    }
    ...
    return (
        <ThemedView>
            ...
            <View style={[styles.container]}>
                ...
                <ThemedText type={'default'}>Add friends to stay in touch, share memories, and never miss a birthday</ThemedText>
            </View>
                <BottomSheetModalProvider>
                    <BottomSheet
                        ...
                        style={[{backgroundColor, borderTopLeftRadius: 20, borderTopRightRadius: 20}]}
                        ...
                        <BottomSheetView style={styles.contentContainer}>
                            ...
                            <NewFriendSettings frequency={selectedFrequency} setFrequency={setSelectedFrequency} contact={newContact} />
                        </BottomSheetView>
                    </BottomSheet>
                </BottomSheetModalProvider>
            </GestureHandlerRootView>
